...
session = tf.Session()
saver = tf.train.import_meta_graph(r"inference\2017-09-08-04-52\model.meta")
saver.restore(session, tf.train.latest_checkpoint(r"inference\2017-09-08-04-52"))

graph = tf.get_default_graph()
dataset = graph.get_tensor_by_name("dataset:0")
model = graph.get_tensor_by_name("model:0")

pathname = "handwritten.jpg"
pixel_depth = 255.0
